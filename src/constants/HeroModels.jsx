export const HeroModels = [
  {
    id: 1,
    image: "hero2",
    heading: "Keplex Training — Practical Skills, Real Results",
    paragraph:
      "We offer nourishing lip glosses and other lip care products at both retail and wholesale prices.",
    actions: [
      { label: "Register Now", href: "#registration", primary: true },
      { label: "Watch Intro", href: "#video", primary: false },
    ],
  },
  {
    id: 2,
    ...
    actions: [{ label: "Explore Courses", href: "#courses", primary: true }],
  },
  {
    id: 3,
    image: "herobg4",
    heading: "Lipcare Training",
    paragraph:
